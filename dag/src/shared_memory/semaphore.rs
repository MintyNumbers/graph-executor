use libc::{
    c_int, c_uint, /*mmap, munmap,*/ sem_close, sem_open, sem_post, sem_trywait, sem_unlink, sem_wait, strerror, /*MAP_FAILED, MAP_SHARED,*/ O_CREAT,
    /*PROT_READ, PROT_WRITE,*/ SEM_FAILED, S_IRUSR, S_IWUSR,
};
